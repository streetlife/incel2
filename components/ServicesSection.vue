    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div 
          ...
          :key="service.title"
          class="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group reveal"
          :style="{ animationDelay: `${index * 100}ms` }"
        >
          <div class="mb-6">
            <div 
              class="w-16 h-16 bg-gradient-primary rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300"
              v-html="service.icon"
            ></div>
          </div>
...
const services = [
  ...
  },
  {
    ...
    icon: '<svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>'
  },
  {
